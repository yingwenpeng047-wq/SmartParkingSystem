...
//枚举：请求类型
enum protocolType {
	USER_T, REGISTER_T, RESULTBACK_T,
	INRECORD_T, INFOSEARCH_T, OUTRECORD_T,
	INFOBACK_T, VIDEOPLAY_T, VIDEOBACK_T,
	FILEINFO_T, FILEBACK_T, FILECHECK_T,
	VIDEODAY_T, VIDEOMONTH_T, VIDEOUPDATE_T,
	LIFE_T,UPDATETABLE_T
};
